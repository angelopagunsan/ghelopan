...
function x(){
$.ajax({
	url: "http://www.omdbapi.com/?t=The-Amazing-Spider-Man-2"
}).done(function(res){
	console.log(res);
	let html = `
	<center>
		...
		<h3>Type: ${res.Type}</h3>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/DlM2CWNTQ84" frameborder="0" allowfullscreen></iframe>
