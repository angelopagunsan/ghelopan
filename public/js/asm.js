...
function x(){
$.ajax({
	url: "http://www.omdbapi.com/?t=The-Amazing-Spider-Man"
}).done(function(res){
	console.log(res);
	let html = `
	<center>
		...
		<h3>Type: ${res.Type}</h3>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/BXx51SR_3Sk" frameborder="0" allowfullscreen></iframe>
